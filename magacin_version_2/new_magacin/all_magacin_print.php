...
<div style="width:750px; height:250px; float:left; margin-left:20px; margin-right:10px;  ">
	...
	<table class="Printtable">
		<thead>	
		      <tr>
				...
				<th width="150px">Шифра</th>
				<th width="50px">Количина</th>
				<th width="75px">Цена</th>
				<th width="75px">Вкупно продукт</th>
			  </tr>
		</thead>
		<tbody>
		    <?php
	...
	<div style="float:left; font-size:24; margin-top:30px;"><b> Вкупна вредност магацин: </b><?php echo $suma;?></div>
